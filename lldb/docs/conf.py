...
# Simplified setup for documentation-only builds - removed Python API generation
...
# Disabled Python API documentation generation
...
# Disabled Python API documentation generation for documentation-only builds
# if not building_man_page:
#     try:
...
# Disabled Python API documentation processing
...
# Disabled regex patterns for automodapi processing
...
# Disabled automodapi processing functions for documentation-only builds
